...
?>
                ...
                <div class="grid">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      ...
                      <p><a href="http://localhost/laba/3str.php#"><img src="к/кфс.jpg" width="250" 
                        height="170" alt="спец.пр."></a></p>
   ...
   <div class="grid" >
                    <div class="grid">
                      <div class="row">
                       <?php
                        $requestCount = "SELECT COUNT(*) FROM restaurant";
                          ...
                          foreach ($items as &$item) {
                            ...
                            echo '<div class="col">
                                    <div class="card" style="width: 18rem;">
                                      <img src="'.$item["img"].'" width="250"  height="180" class="card-img-top" alt="ресторан">
                                      <div class="card-body">
                                        <p>м. '.$item["address"].'</p>
                                        <a href="'.$link.'" class="btn btn-primary">'.$item["name"].'</a>
                                      </div>
                                    </div>
                                  </div>';
                          }
                        } else {
                          echo '<p>Рестораны сейчас недоступны :C</p>';
                        }
                       ?>
                        </div>
                      </div>
